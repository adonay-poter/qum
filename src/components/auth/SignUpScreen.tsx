...
export function SignUpScreen() {
  const { signUp, openSignIn } = useAuth();
  ...
  return (
    <Page>
      <div className="flex flex-col justify-center py-8">
        ...
        <p className="mt-qum-lg text-label uppercase text-tertiary">Create account</p>
        <h1 className="mt-qum-sm text-h1 text-primary">Join QUM</h1>
